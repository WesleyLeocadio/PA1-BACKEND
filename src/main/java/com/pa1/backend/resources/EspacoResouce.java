...
public class EspacoResouce {
	...
	public ResponseEntity<?> find(@PathVariable Integer id) {//ResponseEntity<?> tipo especial do spring que ja encapsula varias informações de uma respota http para um servico rest    
