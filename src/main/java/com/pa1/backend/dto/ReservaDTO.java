...
public class ReservaDTO  implements Serializable{
	...
	public ReservaDTO(String data, String justificativa, Integer[] horarios, Integer[] diaSemana, Boolean aprovada, Boolean cancelada, Espaco espaco, Usuario usuario) {
		this.data = data;
